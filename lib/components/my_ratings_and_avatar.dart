    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          Wrap(
            children: List.generate(
              ...
              (index) {
                return Icon(
                  Iconsax.star1,
                  color: index < gottenStars ? Colors.amber : MyColors.textSecondary,
                );
              },
            ),
          ),
          ...
          const Row(
            children: [
              MyUserAvatar(image: MyImages.avatar),
              MyUserAvatar(image: MyImages.avatar1),
              MyUserAvatar(image: MyImages.avatar2),
              MyUserAvatar(image: MyImages.avatar3),
            ],
          ),
        ],
      ),
